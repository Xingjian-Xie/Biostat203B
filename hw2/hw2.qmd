...
admissions_tble %>%
ggplot() +
  geom_bar(aes(x = (dischtime-admittime)/2400)) +
  xlim(0,30) + xlab('length of stay (day)')

```
I filter out people with length of stay greater than 30 days. Otherwise, it is impossible to see the majority of the patterns. Most people stay in hospital between 0 to 10 days. The data looks nearly normally distributed between 0 day and 8 day. There are 589 people stay longer than 30 days.
